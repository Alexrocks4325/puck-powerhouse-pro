...
export default {
	...
	theme: {
      ...
      colors: {
        ...
        "pack-bronze": "hsl(var(--pack-bronze))",
        "pack-silver": "hsl(var(--pack-silver))",
        "pack-gold": "hsl(var(--pack-gold))",
        "pack-elite": "hsl(var(--pack-elite))",
      },
			borderRadius: {
				lg: 'var(--radius)',
			...
			animation: {
				...
				'stanley-cup': 'stanley-cup 2s ease-in-out',
